    ...
    <div class="mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('neighbourhoods') }}" :active="request()->routeIs('neighbourhoods')">
                        {{ __('Mahalleler') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('personnels') }}" :active="request()->routeIs('personnels')">
                        {{ __('Personel') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('lands') }}" :active="request()->routeIs('lands')">
                        {{ __('Arsa') }}
                    </x-nav-link>
                </div>
