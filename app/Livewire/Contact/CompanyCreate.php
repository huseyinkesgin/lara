...
class CompanyCreate extends BaseCreateLocation
{
    ...
    {
        $this->reset('code', 'name', 'tax_name', 'tax_office', 'tax_number', 'phone', 'email', 'mersis_number', 'kep_address', 'website', 'city_id', 'district_id', 'neighbourhood_id', 'address', 'description', 'is_active');
    }
    ...
    public function save()
    {
       $validatedData = $this->validate();
        ...
        session()->flash('error', 'Şirket kaydedilirken bir hata oluştu.');
    }
    }
